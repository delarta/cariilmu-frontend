      ...
      <div className="home">
          ...
          <Container className="banner-grid">
            <div className="banner-text">
              ...
              <div className="banner-buttons">
                <Link className="btn btn-primary" to='/content'>Unduh Sekarang</Link>
                <Link className="btn btn-primary" to='/signup-mentor'>Unduh Sekarang</Link>
              </div>
            </div>
        ...
        <section className="fitur">
          <Container className="fitur-grid">
            <div>
              ...
              <p>Enroll to your desired class anywhere and whenever you need it</p>
            </div>
            <div className="text-center">
              <img src={phone} alt={phone}/>
            </div>
        ...
        <section id="misi">
          <Container className="misi-grid">
            ...
            <div className="text-center">
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates neque labore obcaecati, nulla quae magnam placeat voluptatum dolorum vel recusandae molestiae ore aliquid asperiores libero, iste aperiam veniam, impedit quae quibusdam voluptates deserunt repellendus ab dolorum maxime fuga iusto consectetur.</p>
        ...
        <section id="download">
          <Container className="download-grid">
            <div>
              ...
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Accusamus beatae quas dolores laudantium praesentium ducimus doloremque itaque cum neque. Aperasperiores repellendus ut explicabo, qui odio. Quibusdam hic quae voluptas recusandae ex </p>
